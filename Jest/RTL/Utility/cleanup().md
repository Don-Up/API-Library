...
- <audio src="C:\Users\10691\Downloads\__`cleanup`___ .mp3"></audio>

> **`cleanup()`**：React Testing Library 中的工具，用于在每个测试后卸载组件并清除 DOM，以防止内存泄漏和测试之间的干扰。现代版本中会自动执行，但可以手动调用。
>
> <audio src="C:\Users\10691\Downloads\cleanup()：React.mp3"></audio>
...
<audio src="C:\Users\10691\Downloads\这段代码展示了如何使用 Rea (29).mp3"></audio>
